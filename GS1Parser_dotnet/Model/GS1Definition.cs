...
namespace Gs1Parser_dotnet
{
    public class GS1Definition
    {
        ...
        public GS1Definition()
        {
            ...
            Add("8012", "Software Version", DataType.Alphanumeric, 14, true);
        ...
        {
            string[,] table = new string[AIDict.Count + 1, 6];
            table[0, 0] = "AI";
            ...
            foreach (KeyValuePair<string, AI> item in AIDict)
            {
